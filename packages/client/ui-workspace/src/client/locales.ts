...
export const zh = {
  ...
  'archived.title': '已归档',
  'archived.description': '查看已归档会话不会取消归档。取消归档后，会话将重新显示在侧边栏中。',
  'archived.loading': '正在加载已归档会话…',
  'archived.loadError': '无法加载已归档会话。',
  'archived.empty': '暂无已归档会话',
  'archived.unavailable': '此会话暂不可用，仍可取消归档。',
  'archived.view': '查看',
  'archived.restore': '取消归档',
  'archived.restoring': '正在取消归档…',
  'archived.restoreError': '取消归档失败：{error}',
...
export const en = {
  ...
  'archived.description': 'View archived sessions without unarchiving them. Unarchive a session to show it in the sidebar again.',
  'archived.loading': 'Loading archived sessions…',
  'archived.loadError': 'Could not load archived sessions.',
  'archived.empty': 'No archived sessions',
  'archived.unavailable': 'This session is unavailable. You can still unarchive it.',
  'archived.view': 'View',
  'archived.restore': 'Unarchive',
  'archived.restoring': 'Unarchiving…',
  'archived.restoreError': 'Could not unarchive: {error}',
